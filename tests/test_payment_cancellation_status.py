...
class PaymentCancellationStatusTests(unittest.TestCase):
    ...
    def test_cannot_cancel_another_merchants_payment(self):
        ...
        response = self.client.post(
            f"/api/v1/payments/{payment["reference"]}/cancel",
    ...
    def test_cancel_existing_payment(self):
